...
var texture=new THREE.TextureLoader().load('textures/01.png')
var material2 = new THREE.MeshBasicMaterial( { map: texture } );
var texture1=new THREE.TextureLoader().load('textures/02.jpg')
var material3 = new THREE.MeshBasicMaterial( { map: texture1 } );
var texture2=new THREE.TextureLoader().load('textures/03.jpg')
