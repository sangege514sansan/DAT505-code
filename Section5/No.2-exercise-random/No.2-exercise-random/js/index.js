...
for (var x = -10; x <= 10; x += 5 ) {// Start from -45 and sequentially add one every 5 pixels
  for (var y = -10; y <= 10; y += 5) {
    var boxGeometry = new THREE.SphereGeometry(10, 0.01, 16,100);
...
if (x==-5 && y==-5){
  ...
  boxMaterial = new THREE.MeshLambertMaterial({color:  0xFFFFFF});
             ...
             var randomValueX = (Math.random() * 0.1) - 1;
...
cubes[1].geometry = new THREE.CubeGeometry(0.2,10,5);
